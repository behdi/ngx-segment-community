 ...
 *
 * **DO NOT USE DIRECTLY.**
 * This is used under the hood to power the `with*` provider pattern (e.g., `withPlugins`, etc.),
 ...
 * ```
 *
 * @param config - The mandatory static configuration (Write Key, CDN, etc) for segment.
